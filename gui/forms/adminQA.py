...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.scrollAreaWidgetContents_2.setGeometry(QtCore.QRect(0, 0, 709, 906))
        ...
        self.horizontalLayout_3.addWidget(self.dbBtn)
        ...
        self.applyBt = QtWidgets.QPushButton(self.scrollAreaWidgetContents_2)
        self.applyBt.setObjectName("applyBt")
        self.horizontalLayout_4.addWidget(self.applyBt)
    ...
    def retranslateUi(self, Form):
        ...
        Form.setWindowTitle(_translate("Form", "管理者画面（質問）"))
        ...
        self.applyBt.setText(_translate("Form", "確定"))
