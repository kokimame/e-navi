...
class Ui_topView(object):
    def setupUi(self, topView):
        ...
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap("../image/enavi_btn.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.enaviBtn.setIcon(icon4)
        ...
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap("../image/elearning_btn.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.elearningBtn.setIcon(icon5)
        ...
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap("../image/ecareer_btn2.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
